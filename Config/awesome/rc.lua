...
beautiful.init("/home/rudy/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    mytextclock.format = "%I:%M %p - %a %b %d, %Y"

    --Create a drop down calender widget attached to the clock
    myDDCalender = awful.widget.calendar_popup.year()
    myDDCalender:attach(mytextclock, "tc")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "t", function() awful.layout.set(awful.layout.suit.tile) end,
                {description = "Switch to the tile left layout", group = "Layouts"}),
    -- Float
    awful.key({ modkey }, "f", function() awful.layout.set(awful.layout.suit.floating) end,
                {description = "Switch to the floating layout", group = "Layouts"}),
    -- Toggle Title Bars
    awful.key({modkey, "Shift"}, "t", function() awful.titlebar.toggle(client.focus) end,
                {description = "Toggle the title bar", group = "Layouts"}),
